...
const drawChart = (arrOfXPoints, func, clr, isRotating) => {
    ...
    for (let i = 0; i < arrOfXPoints.length; i++) {
        ...
        /*Метод "save()" сохраняет все состояния холста и добавляет текущее состояние в стек. Состояние чертежа,
        ...
        /*Метод "restore()" восстанавливает предварительно сохраненное состояние холста из стека. Если состояние ранее
        не сохранялось, то метод ничего не делает.*/
        ctx.restore();
    };
};
